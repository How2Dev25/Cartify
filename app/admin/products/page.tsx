          ...
          >
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute bottom-0 right-0 bg-orange-500 text-white p-1.5 rounded-full shadow-lg hover:bg-orange-600 transition-colors"
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {additionalImages.map((img, idx) => (
                      <div key={idx} className="relative group">
                        <div className="w-24 h-24 rounded-lg bg-gray-100 overflow-hidden border border-gray-200">
                    ...
                    <button
                      ...
                      className="w-24 h-24 rounded-lg border-2 border-dashed border-gray-300 flex items-center justify-center hover:border-orange-500 hover:bg-orange-50 transition-colors"
                    >
                  ...
                  <p className="text-xs text-gray-400 mt-2">Hover over images to see delete button</p>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  {formData.details.map((detail, idx) => (
                    <div key={idx} className="flex items-center gap-2 group">
                      <span className="flex-1 px-3 py-2 bg-gray-50 rounded-lg text-sm text-gray-700">{detail}</span>
                      <button
              ...
              <div>
                ...
                {formData.sizes.length > 0 ? (
                  ...
                  <p className="text-sm text-gray-400 italic">Select a category to see available sizes</p>
                )}
                <p className="text-xs text-gray-500 mt-1">Sizes are automatically set based on category selection</p>
              </div>
                ...
                <div className="space-y-3">
                  <div className="flex flex-wrap gap-3">
                    {formData.colors.map((color, idx) => (
                      <div key={idx} className="flex items-center gap-2 group">
                        ...
                        />
                        <span className="text-sm text-gray-700">{formData.color_names[idx]}</span>
                        <button
                          onClick={() => removeColor(idx)}
                          className="text-red-500 hover:text-red-700 ml-1 opacity-0 group-hover:opacity-100 transition-opacity"
                  ...
                  <div className="flex gap-2">
                    <select
                      ...
                      onChange={(e) => {
                        const selected = commonColors.find(c => c.value === e.target.value);
                        if (selected) setTempColor(selected);
                      }}
                      className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none"
                    >
            ...
            <div className="sticky bottom-0 bg-gray-50 p-6 border-t border-gray-200 rounded-b-2xl flex justify-end gap-3">
              ...
              <button
                onClick={saveProduct}
                disabled={uploadingImage}
                className="px-4 py-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-lg hover:from-orange-600 hover:to-orange-700 transition-colors font-medium shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
              >
